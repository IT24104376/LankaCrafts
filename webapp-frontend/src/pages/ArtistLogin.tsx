    ...
    <div
      ...
      <div className="flex-1 flex items-center justify-center px-8 py-12 relative overflow-hidden z-10">
        ...
        <motion.div
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="flex items-center gap-2 mb-3">
              <svg width="36" height="36" viewBox="0 0 32 32" fill="none">
                ...
                <circle cx="16" cy="16" r="3.5" fill="#2F5D50" />
              </svg>
              <span className="text-2xl font-display font-bold" style={{ color: '#2F5D50' }}>
                Lanka Crafts
              </span>
            </div>
          ...
          <p className="text-sm text-gray-400 mb-7 font-body">Sign in to manage your artisan profile</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-[#2F5D50] focus:border-transparent outline-none text-sm font-body transition-shadow" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-12 pr-12 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-[#2F5D50] focus:border-transparent outline-none text-sm font-body transition-shadow" />
                <button
                  type="button"
            ...
            <div className="flex justify-center pt-1 flex-col items-center">
              <button type="button" onClick={handleForgotPassword} disabled={loading} className="text-sm font-semibold font-body hover:underline" style={{ color: '#2F5D50' }}>
                Forgot Password?
              </button>
              {resetSent && (
            ...
            <motion.button
              ...
              onMouseEnter={(e) => { if (!loading) e.currentTarget.style.backgroundColor = '#1A4D45'; }}
      ...
      <div className="hidden lg:flex w-[45%] relative overflow-hidden">
        ...
        <div
          ...
          style={{ background: 'linear-gradient(to bottom, rgba(47,93,80,0.3) 0%, rgba(30,30,30,0.75) 100%)' }} />
