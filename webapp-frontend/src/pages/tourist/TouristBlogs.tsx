...
const BLOG_POSTS: { id: number; img: string; imgHeight: string; workshopTag: string; title: string; excerpt: string; author: string; country: string; date: string; likes: number }[] = [];

const POSTS_PER_PAGE = 6;
const TRENDING_TAGS: string[] = [];

const TOP_CONTRIBUTORS: { initials: string; name: string; country: string; posts: number }[] = [];
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="flex gap-6 items-start">
            ...
            <div className="flex-1 flex flex-col gap-6">
              {BLOG_POSTS.length === 0 ?
              <p className="text-center text-gray-500 py-16 font-body">
                No blog posts yet.
              </p> :
              <>
            ...
            <aside className="hidden xl:block w-72 shrink-0 space-y-4 sticky top-24">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <p className="text-xs text-gray-400 font-body">No trending tags yet.</p> :
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-gray-400 font-body">No contributors to show yet.</p> :
